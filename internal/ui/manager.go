...
// In Fyne UI on Windows and macOS, transparency is always fixed to 100%
// (fully opaque content with a transparent window background).
func (u *UIManager) SetOpacity(_ int) {
