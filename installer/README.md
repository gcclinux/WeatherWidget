...
.\installer\build-msi.ps1 -Version "1.0.5" -SkipSign

# Signed with certificate from Windows certificate store:
.\installer\build-msi.ps1 -Version "1.0.5" -CertThumbprint "THUMBPRINT"

# Signed with a .pfx file:
.\installer\build-msi.ps1 -Version "1.0.5" -CertPath "cert.pfx" -CertPassword "pass"
```
